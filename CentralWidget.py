...
class CentralWidget(QWidget):
    def __init__(self, parent=None):
        ...
        push_button_add.released.connect(self.handle_math)
        push_button_sub.released.connect(self.handle_math)
        push_button_mul.released.connect(self.handle_math)
        push_button_div.released.connect(self.handle_math)
    ...
    def handle_equal(self):
        right_value = float(self.__current_value)
        left_value = float(self.__last_value)
